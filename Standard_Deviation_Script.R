...
SD_Classroom,Computer,SD_Network,SD_See_Hear,SD_Had_Knowledge_Skills, SD_Learned_What_I_Needed, SD_Technical_Details))
...
write.csv(MPLS_Scores, "MPLS_Scores.csv")
